...
betas=[0.01, 0.1, 0.5, 0.9, 1,1.2,1.3,1.4,2,3,5,7,8,10,11]
N=length(betas)
benefits = zeros(N)
CVAR = zeros(N)
for n in 1:N
...
plot(benefits, CVAR, label="Day ahead production (MW)", xlabel="t (h)", ylabel="power (MW)", title="Day ahead production (MW)", linewidth=2)
